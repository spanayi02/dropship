      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              {isSale && (
                <span className="inline-flex items-center gap-1.5 rounded-full bg-destructive/10 px-3 py-1 text-xs font-extrabold text-destructive mb-3">
            ...
            <div className="rounded-2xl border border-border bg-card p-5 shadow-xl shadow-emerald/5">
              <div className="flex flex-wrap items-end justify-between gap-4">
                ...
                {savings > 0 && (
                  <span className="rounded-full bg-destructive/10 px-3 py-1.5 text-sm font-extrabold text-destructive">
