        ...
        >
          ...
          <div className="mt-auto flex items-center justify-between gap-2 pt-3 border-t border-border">
            <div className="flex items-center gap-1.5">
              ...
              {review.isVerified && (
                <span className="label-sign rounded-md bg-go/15 text-go px-1.5 py-0.5">
                  {t("home.verified")}
                </span>
              )}
            </div>
            <Link
              ...
              className="text-xs text-muted-foreground hover:text-foreground transition-colors truncate max-w-[45%]"
            >
              {review.productTitle}
            </Link>
          </div>
